...
export default function Quiz() {
  ...
  const generatePDF = () => {
    ...
    doc.setFillColor(255, 245, 230); // Very light orange/saffron tint
    ...
    doc.text(`For successfully completing the VoteSahayak Knowledge Quiz`, 148, 130, { align: "center" });
    doc.text(`with a score of ${score}/${QUESTIONS.length}.`, 148, 142, { align: "center" });
              ...
              return (
                <button
                  ...
                  className={clsx(
                    ...
                    !showCorrectness && "border-slate-800 bg-slate-800/50 hover:border-slate-600 hover:bg-slate-800 text-slate-200",
                    showCorrectness && isCorrect && "border-green-500 bg-green-500/10 text-green-400",
                    showCorrectness && isSelected && !isCorrect && "border-red-500 bg-red-500/10 text-red-400",
                    showCorrectness && !isSelected && !isCorrect && "border-slate-800 opacity-50 text-slate-400"
                  )}
                >
                  <span>{opt}</span>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-slate-400 mb-8">
              You scored <span className="text-xl font-bold text-white">{score}</span> out of {QUESTIONS.length}
            </p>
